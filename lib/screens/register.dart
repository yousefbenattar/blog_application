...
class _RegisterState extends State<Register> {
  ...
  void _registerUser () async {
    ApiResponse response = await register(nameController.text, emailControllert.text, passwordController.text);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(child: Form(
        ...
        TextFormField(
          obscureText: false,
          validator: (value) => value != passwordController.text ? "Confirm password dosent match" : null,
